...
class Tab implements PictureListener {
    ...
    private final WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if (tc != null) {
                Log.d(TAG, "[" + tc.getTabPosition(Tab.this) + "/" + tc.getTabCount()
        ...
        public void onReceivedError(WebView view, int errorCode,
            ...
            Log.d(LOGTAG, "error code: " + errorCode + " url: " + failingUrl);
        ...
        public void onReceivedSslError(final WebView view,
            ...
            Log.d(LOGTAG, "onReceivedSslError error code: " + error + " handler: " + handler, new Throwable("onReceivedSslError"));
            if (!mInForeground) {
                handler.cancel();
    ...
    private class CancelSavePageTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            while (iter.hasNext()) {
                ...
                opList.add(ContentProviderOperation.newDelete(ContentUris.withAppendedId(Snapshots.CONTENT_URI, id)).build());
            }
            try {
                mContext.getContentResolver().applyBatch(SnapshotProvider.AUTHORITY, opList);
            } catch (OperationApplicationException ope) {
                Log.e(LOGTAG, "Failed to delete save page. OperationApplicationException: " + ope.getMessage());
