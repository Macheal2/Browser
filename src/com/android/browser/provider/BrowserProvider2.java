...
import com.android.browser.provider.Browser.BookmarkColumns;
...
public class BrowserProvider2 extends SQLiteContentProvider {
    ...
    final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void createDefaultBookmarks(SQLiteDatabase db) {
            ...
            mBrowserBookmarkExt = Extensions.getBookmarkPlugin(getContext());
            if ((position = mBrowserBookmarkExt.addDefaultBookmarksForCustomer(db)) == 0) {
